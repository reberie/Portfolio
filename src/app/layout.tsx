...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Buianto (Ben) Sodnomov — Software Developer in Toronto',
    template: '%s — Buianto (Ben) Sodnomov',
  },
  description: DESCRIPTION,
  authors: [{ name: 'Buianto (Ben) Sodnomov' }],
  alternates: { canonical: '/' },
  openGraph: {
    type: 'website',
    url: '/',
    siteName: 'Buianto (Ben) Sodnomov',
    locale: 'en_CA',
    title: 'Buianto (Ben) Sodnomov — Software Developer in Toronto',
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Buianto (Ben) Sodnomov — I build things that ship.',
      },
    ],
  },
  twitter: {
