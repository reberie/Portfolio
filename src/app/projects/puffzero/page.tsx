  ...
  return (
    <div className="container case-study">
      ...
      <section className="case-hero">
        <span className="label case-hero__label fade-in">
        ...
        <p className="case-hero__summary fade-in">
          A cross-platform mobile app that helps users track and quit vaping. Designed
          with a collaborating designer, built end-to-end, and published to the Apple App
          Store.
        </p>
      </section>
      ...
      <section className="case-section fade-in">
        ...
        <div className="case-section__body">
          <p>
            Vaping has become a widespread habit, especially among young adults, but most
            quitting tools are either overly clinical or designed for cigarette smokers.
            There was a gap for a modern, approachable app that specifically targets vaping
            habits.
          </p>
          <p>
            I wanted to build something that was genuinely useful — not just a timer, but a
            tool that helps users understand their patterns, stay motivated, and see real
            progress.
          </p>
        </div>
      </section>
      ...
      <section className="case-section fade-in">
        ...
        <div className="case-section__body">
          <ul>
            <li>
              Sole developer — designed the architecture, wrote all code, handled
              deployment
            </li>
            <li>
              Collaborated with a designer on the UI, iterating based on product needs and
              technical constraints
            </li>
            <li>Managed the full App Store submission and review process</li>
            <li>
              Handled API integrations, local data persistence, and cross-platform
              compatibility
            </li>
          </ul>
        </div>
        ...
        <div className="decisions">
          <div className="decision-card">
            ...
            <p className="decision-card__text">
              Health and habit data is sensitive. Keeping data on-device by default was both
              a privacy-first decision and a way to simplify the architecture — no backend
              to build or maintain for v1.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="case-section fade-in">
        ...
        <div className="case-section__body">
          <ul>
            <li>
              <strong>App Store review process</strong> — Navigating Apple&apos;s guidelines
              for the first time required multiple submission iterations. Each rejection was
              a learning moment in understanding platform requirements.
            </li>
            <li>
              <strong>Responsive layouts across devices</strong> — Making sure the UI looked
              neat and consistent across the range of iPhone screen sizes required careful
              handling of spacing, typography scaling, and safe areas.
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="case-section fade-in">
        ...
        <div className="case-section__body">
          <p>
            This was my first time taking an app from idea to production. The biggest lesson
            was that shipping is a skill on its own — writing code is maybe 60% of the work.
            The rest is design decisions, testing on real devices, navigating store
            requirements, and making hard calls about scope.
          </p>
          <p>
            I also learned the value of working with a designer early. Having a collaborator
            who challenged my assumptions about the UI made the final product significantly
            better than what I would have built alone.
          </p>
        </div>
      </section>
      ...
      <section className="case-cta fade-in">
        <a href={APP_STORE_URL} target="_blank" rel="noopener" className="btn btn--primary">
          View on App Store
        </a>
        <Link href="/#projects" className="btn btn--tertiary">
          See other projects
        </Link>
      </section>
    </div>
